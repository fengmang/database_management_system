...
$query = "select teamname ,sum (Yellow_cards) as Yellow_cards
From ((Select hometeam as teamname,sum(HY)as Yellow_cards
From match
Where div='".$league."' and (day>'".$year2."' and day<'".$year1."')
Group by hometeam) union
(Select awayteam as teamname ,sum(HY)as Yellow_cards
From match
Where div='".$league."' and (day>'".$year2."' and day<'".$year1."')
Group by awayteam))
Group by teamname
...
?>
<form action="r_j.php" method="post">
