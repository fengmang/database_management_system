...
<p>Several funtions listed below :</p>
<ol>
<li><a  href="compare.php">Player comparison</a></li>
<li><a  href="playersposition.php">players in the same position   </a></li>
<li><a  href="playersteam.php">players in the same team</a></li>
<li><a  href="r_e.php">Total of players in each league</a></li>
<li><a  href="r_f.php">The mean guy (Average height and rating of players):</a></li>
</ol>



<form align="center" action="result.php" method="get">
  Search for a player by name: <input type="text" name="name" /><input type="submit" value="Submit" />
</form>
