...
<form align="center" action="teamresults.php" method="get">
  Search for players in a team by entering the teamname: <input type="text" name="club" /><input type="submit" value="Submit" />
</form>
