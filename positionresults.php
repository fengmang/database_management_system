...
<a  align="center" href="playersposition.php">Return to playersposition search page</a><br>
...
$position = ucfirst(strtolower($_GET['position']));

$q = "SELECT * FROM PLAYERS WHERE POSITION LIKE '%$position%' ";
