...
$query = "select teamname ,sum (offsides) as offsides
From ((Select hometeam as teamname,sum(HO)as offsides
From match
Where div='".$league."' and (day>'".$year2."' and day<'".$year1."')
Group by hometeam) union
(Select awayteam as teamname ,sum(HO)as offsides
From match
Where div='".$league."' and (day>'".$year2."' and day<'".$year1."')
Group by awayteam))
Group by teamname
...
<table align="center" border="1px">
		...
		<td align="center"><b>Teamname</b></td> 
              <td align="center"><b>Offsides</b></td> 
		</tr>
<?php
...
?>
<form action="r_k.php" method="post">
