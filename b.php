...
$query = "Select teamname, sum(goals) as goals
From((Select hometeam as teamname,sum(FTHG) as goals
From match where (day <'".$year1."' and day>'".$year2."') and div='".$league."'
Group by hometeam ) union
(Select awayteam as teamname,sum(FTAG) as goals
From match where (day <'".$year1."' and day>'".$year2."') and div='".$league."'
Group by awayteam ))
Group by teamname
Order by goals desc";
